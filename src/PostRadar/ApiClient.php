...
class ApiClient
{
    ...
    const API_URL = 'https://api.postradar.ru';
    ...
    {
        $this->client = new Client(self::API_URL, array('X-Api-Token' => $apiKey));
        Wrap::getInstance()->client = $this->client;
    }

    public function __call($method, $args)
    {
        return Wrap::getEntity($method, $args);
    }
